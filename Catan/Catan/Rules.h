...
class Rules {
public:
	bool canBuildTown(Player *, Player *, Coordinates, bool);// La idea seria que el dispatcher haga un if(canBuild) y ahi haga el build si puede hacerlo
	...
	bool hasAdjacentRoad(Player *, Coordinates);
private:
