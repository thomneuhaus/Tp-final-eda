...
public:
	...
	void findNumber(int, Player *, resources resources[], Coordinates coordinates);//FUNCIONA // encuentra todas las islas que tienen el numero tirado por el dado y si el numero era un 7 se encarga de llamar a la funcion que mueve al robber
	...
	void takeResources(Player *, resources []); // le saca la mitad de resources al player cuando sale el robber si el player tiene mas de 7 recursos
